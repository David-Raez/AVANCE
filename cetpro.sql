...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-08-2025 a las 02:05:32
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listadousuarios` ()   SELECT U.ID_USUARIO, U.TIPO_DOC, U.N_DOCUMENTO_USUARIO, CONCAT(U.NOMBRES,', ', U.APE_PATERNO,' ',U.APE_MATERNO), U.TIPO_CONTRATO, U.N_RD, R.NOMB_ROL, D.NOMBRE_DISTRITO, U.CELULAR, U.SEXO, U.FECHA_NACIMIENTO, U.ESTADO, U.FECHA_REGISTRO FROM USUARIO U JOIN ROL R ON U.ID_ROL=R.ID_ROL JOIN DISTRITO D ON U.ID_DISTRITO=D.ID_DISTRITO ORDER BY 1 ASC$$
...
('$2y$10$SO.6anawmFVc.g88N7rgW.GmQ6S3qHYSHhud33tqm7QuTMAhO6Xz6', 'DNI', '12345678', 'prueba', 'prueba', 'prueba prueba', 'SIN ESTUDIOS', 'M', 'prueba@gmail.com', '987654321', '150101', 'av. el sol 511', '', 'Soltero', 0, '', '', '', 'PERÚ', 'LIMA', 'LIMA', 'LIMA', 'HOSPITAL', '2025-08-15', 5, 10, 1, '2025-08-15 22:56:31'),
('', 'DNI', '87654321', 'prueba', 'prueba', 'prueba prueba', '', 'M', 'prueba@gmail.com', '987654321', '150101', 'av. el sol 511', 'Estudiante', 'Soltero', 0, '', '', 'AFP', 'PERÚ', 'LIMA', 'LIMA', 'LIMA', 'HOSPITAL', '2006-06-18', 5, 9, 1, '2025-08-07 21:20:05');
...
INSERT INTO `matricula` (`ID_MATRICULA`, `ID_USUARIO`, `N_DOCUMENTO_ALUMNO`, `ID_CARRERA`, `ID_MODULO_OCUPACIONAL`, `ID_FORM`, `BECADO`, `FECHA_REGISTRO`) VALUES
(13, 9, '87654321', NULL, NULL, NULL, 0, '2025-08-07 21:22:46');
...
(1000, 'PAGO000', 13, NULL, 0.00, '2025-08-08', '2025-08-08 19:12:37');
...
ALTER TABLE `matricula`
  ...
  ADD CONSTRAINT `matricula_ibfk_9` FOREIGN KEY (`ID_CARRERA`) REFERENCES `carrera` (`ID_CARRERA`);
